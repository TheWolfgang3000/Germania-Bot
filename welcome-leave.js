...
function initialize(client) {
    console.log("Welcome/Leave system initializing...");
    client.on('guildMemberAdd', member => {
        if (member.user.bot) return;
        sendWelcomeLeaveMessage(client, member, 'welcome');
    });
    client.on('guildMemberRemove', member => {
        if (member.user.bot) return;
        sendWelcomeLeaveMessage(client, member, 'leave');
    });
    console.log("Welcome/Leave system initialized successfully.");
}
